...
const Update = () => {
  ...
  const onSubmit = (data) => {
    (data.skills = selectedOption), console.log(data);
      ...
      <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
        ...
        <div className="bg-[#FAFAFA] py-10 px-4 lg:px-16 ">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className=" create-job-flex">
              <div className="lg:w-1/2 w-full">
                ...
                <input
                  ...
                  type="url"
                  placeholder="Paste your Company Logo URL: https://anylogo.com"
            ...
            <input
              type="submit"
              className="block mt-12 bg-blue-600 text-white font-semibold px-8 py-2 rounded-sm cursor-pointer"
            />
          </form>
        </div>
      </div>
